...
import layermanager.fields
import layermanager.models.core
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Title of the category', max_length=255, verbose_name='title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='layermanager.category', verbose_name='category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('layer', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='wms_request_styles', to='layermanager.wmslayer', verbose_name='WMS Request Styles')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('layer', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='wms_request_params', to='layermanager.wmslayer', verbose_name='WMS Requests Additional Parameters')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('layer', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='wms_request_layers', to='layermanager.wmslayer', verbose_name='WMS Request Layers')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='layermanager.dataset')),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default', models.BooleanField(default=False, help_text='Is Default Layer', verbose_name='default')),
                ('legend', wagtail.fields.StreamField([('legend', wagtail.blocks.StructBlock([('type', wagtail.blocks.ChoiceBlock(choices=[('basic', 'Basic'), ('gradient', 'Gradient'), ('choropleth', 'Choropleth')], label='Legend Type')), ('items', wagtail.blocks.ListBlock(wagtail.blocks.StructBlock([('value', wagtail.blocks.CharBlock(help_text="Can be a number or text e.g '10' or '10-20' or 'Vegetation'", label='value')), ('color', wagtail.blocks.CharBlock(help_text='Color value e.g rgb(73,73,73) or #494949', label='color'))]), label='Legend Items', min_num=1))], label='Legend')), ('legend_image', wagtail.images.blocks.ImageChooserBlock())], blank=True, null=True, use_json_field=True, verbose_name='Legend')),
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vector_layers', to='layermanager.dataset', verbose_name='dataset')),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_source', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='gl_styles', to='layermanager.mbtsource', verbose_name='data source')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='sub_categories', to='layermanager.category')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='layermanager.dataset', verbose_name='dataset')),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_maps', wagtail.fields.StreamField([('basemap', wagtail.blocks.StructBlock([('label', wagtail.blocks.CharBlock(label='label')), ('backgroundColor', wagtail.blocks.CharBlock(label='background color')), ('image', wagtail.images.blocks.ImageChooserBlock(label='image', required=False)), ('basemapGroup', wagtail.blocks.CharBlock(label='basemap group')), ('labelsGroup', wagtail.blocks.CharBlock(label='labels group')), ('mapStyle', wagtail.blocks.ChoiceBlock(choices=layermanager.models.core.get_styles, lable='map style')), ('url', wagtail.blocks.URLBlock(label='url', required=False)), ('default', wagtail.blocks.BooleanBlock(help_text='Is default style ?', label='default', required=False))]))], blank=True, null=True, use_json_field=True)),
                ('cap_sub_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='layermanager.subcategory', verbose_name='cap layer sub category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='layer title', max_length=255, verbose_name='title')),
                ('default', models.BooleanField(default=False, help_text='Is Default Layer', verbose_name='default')),
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='file_layers', to='layermanager.dataset', verbose_name='dataset')),
                ('style', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='layermanager.rasterstyle', verbose_name='style')),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
        ...
        migrations.AddField(
            model_name='dataset',
            name='metadata',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='layermanager.metadata', verbose_name='metadata'),
        ),
        migrations.AddField(
            model_name='dataset',
            name='sub_category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='layermanager.subcategory', verbose_name='sub_category'),
        ),
        migrations.CreateModel(
            name='ColorValue',
            fields=[
                ...
                ('layer', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='color_values', to='layermanager.rasterstyle')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bounds', layermanager.fields.ListField(max_length=256)),
                ('layer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vector_tables', to='layermanager.vectorlayer')),
            ],
            options={
                'ordering': ['-time'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('layer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='raster_files', to='layermanager.fileimagelayer', verbose_name='layer')),
            ],
            options={
                'ordering': ['time'],
                'unique_together': {('layer', 'time')},
